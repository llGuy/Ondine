...
RadianceSpectrum GetSolarRadiance() {
  return uSky.sky.solarIrradiance /
    (PI * uSky.sky.solarAngularRadius * uSky.sky.solarAngularRadius);
}
...
RadianceSpectrum GetSkyRadiance(
  ...
  return getSkyRadiance(uSky.sky, transmittance_texture,
...
RadianceSpectrum GetSkyRadianceToPoint(
  ...
  Direction sun_direction, out DimensionlessSpectrum transmittance) {
  return getSkyRadianceToPoint(uSky.sky, transmittance_texture,
                               scattering_texture, single_mie_scattering_texture,
...
IrradianceSpectrum GetSunAndSkyIrradiance(
  ...
  return getSunAndSkyIrradiance(uSky.sky, transmittance_texture,
...
vec3 kSphereCenter = vec3(0.0, 0.0, 1000.0) / kLengthUnitInMeters;
float kSphereRadius = 1000.0 / kLengthUnitInMeters;
vec3 kSphereAlbedo = vec3(0.8);
vec3 kGroundAlbedo = vec3(0.0, 0.0, 0.04);
