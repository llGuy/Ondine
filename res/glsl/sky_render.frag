...
layout (set = 1, binding = 0) uniform sampler3D scattering_texture;
layout (set = 2, binding = 0) uniform sampler3D single_mie_scattering_texture;
layout (set = 3, binding = 0) uniform sampler2D irradiance_texture;
